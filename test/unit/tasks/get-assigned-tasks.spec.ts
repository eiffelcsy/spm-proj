...
describe('GET /api/tasks', () => {
  ...
  it('should return 500 when assigned tasks query fails', async () => {
    supabase = createSupabaseMock({
      staff: createResult({ id: 10, department: 'Engineering' }),
      task_assignees: createResult(null, { message: 'boom', code: 'OTHER' }),
    })
  ...
  it('should return empty result when no tasks assigned', async () => {
    supabase = createSupabaseMock({
      staff: createResult({ id: 10, department: 'Engineering' }),
  ...
  it('should enrich and return assigned tasks', async () => {
    supabase = createSupabaseMock({
      staff: [
